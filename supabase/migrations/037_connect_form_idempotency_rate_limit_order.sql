-- 037_connect_form_idempotency_rate_limit_order.sql
-- <!-- AGENT: ARCHITECT -->
-- Rationale: retries with the same connect-form idempotency key must return
-- the original stable response without consuming additional public rate-limit
-- quota or re-running any submission side effects.
